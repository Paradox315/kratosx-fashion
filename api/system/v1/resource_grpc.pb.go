...
type ResourceClient interface {
	...
	ListRoute(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListRouterReply, error)
}
...
func (c *resourceClient) ListMenu(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListMenuReply, error) {
	out := new(ListMenuReply)
	err := c.cc.Invoke(ctx, "/api.system.v1.Resource/ListMenu", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *resourceClient) ListRoute(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListRouterReply, error) {
	out := new(ListRouterReply)
	err := c.cc.Invoke(ctx, "/api.system.v1.Resource/ListRoute", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ResourceServer interface {
	...
	ListRoute(context.Context, *ListRequest) (*ListRouterReply, error)
...
func (UnimplementedResourceServer) ListMenu(context.Context, *ListRequest) (*ListMenuReply, error) {
...
func (UnimplementedResourceServer) ListRoute(context.Context, *ListRequest) (*ListRouterReply, error) {
...
func _Resource_ListMenu_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ResourceServer).ListMenu(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.system.v1.Resource/ListMenu",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResourceServer).ListMenu(ctx, req.(*ListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Resource_ListRoute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ResourceServer).ListRoute(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.system.v1.Resource/ListRoute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResourceServer).ListRoute(ctx, req.(*ListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Resource_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListMenu",
			Handler:    _Resource_ListMenu_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _Resource_ListRoute_Handler,
		},
	},
