	...
	_user.Roles = userRoles{
		...
		Menus: struct {
			...
			MenuActions: struct {
				...
				RelationField: field.NewRelation("Roles.Menus.MenuActions", "model.MenuAction"),
				MenuActionResources: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Roles.Menus.MenuActions.MenuActionResources", "model.MenuActionResource"),
				},
			},
		},
	}
