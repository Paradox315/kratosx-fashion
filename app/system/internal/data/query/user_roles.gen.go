...
func (u userRoleDo) Joins(field field.RelationField) *userRoleDo {
	return u.withDO(u.DO.Joins(field))
}

func (u userRoleDo) Preload(field field.RelationField) *userRoleDo {
